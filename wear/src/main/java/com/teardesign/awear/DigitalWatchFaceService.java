...
public class DigitalWatchFaceService extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements DataApi.DataListener,
        ...
        public void onAmbientModeChanged(boolean inAmbientMode) {
            ...
            adjustPaintColorToCurrentMode(mBackgroundPaint, mInteractiveBackgroundColor, Color.parseColor("black"));
            adjustPaintColorToCurrentMode(mHourPaint, mInteractiveHourDigitsColor, Color.parseColor("white"));
            adjustPaintColorToCurrentMode(mMinutePaint, mInteractiveMinuteDigitsColor, Color.parseColor("white"));
            // Actually, the seconds are not rendered in the ambient mode, so we could pass just any
            // value as ambientColor here.
            adjustPaintColorToCurrentMode(mSecondPaint, mInteractiveSecondDigitsColor, Color.parseColor("white"));
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
           ...
           // if (!isInAmbientMode() || !mMute) {
                ...
                canvas.drawCircle(bounds.centerX(), bounds.centerY()+50, 25, p);
        ...
        public void onTouchEvent(MotionEvent event) {
            ...
            Log.d(TAG, Float.toString(event.getY()));

            if (event.getX() > (mScreenBounds.centerX() - 25) && event.getX() < (mScreenBounds.centerX() + 25)) {
                if (event.getY() > ((mScreenBounds.centerY() + 50) - 25) && event.getY() < ((mScreenBounds.centerY() + 50) +25)) {
                    Log.d(TAG, "Touch in boundaries...");
                }
            }
