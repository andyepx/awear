 ...
 */
public class DonutProgressAwear extends View {
    ...
    public DonutProgressAwear(Context context) {
        this(context, null);
    }
    ...
    public DonutProgressAwear(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DonutProgressAwear(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String text = prefixText + (progress / 5) + suffixText;
